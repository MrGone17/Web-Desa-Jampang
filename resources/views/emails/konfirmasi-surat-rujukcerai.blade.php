...
<head>
    <meta charset="UTF-8">
    <title>Konfirmasi Surat Keterangan Rujuk Cerai</title>
</head>
<body style="font-family: Arial, sans-serif; background-color: #f3f4f6; padding: 40px;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.05); padding: 30px;">
        <div style="text-align: center; margin-bottom: 30px;">
            <h2 style="color: #1f2937; font-size: 22px; margin-bottom: 8px;">Konfirmasi Pengajuan Surat Keterangan Rujuk Cerai</h2>
        ...
        <p style="font-size: 15px; color: #374151; margin-bottom: 24px;">
            Terima kasih telah mengajukan <strong>Surat Keterangan Rujuk Cerai</strong>. Berikut ini adalah data permohonan Anda yang kami terima:
        </p>
        ...
        <table style="width: 100%; font-size: 15px; color: #374151; border-spacing: 0 10px;">
            ...
            <tr>
                <td><strong>Bin Bapak</strong></td>
                <td>: {{ $data['bin_bapak'] }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td><strong>Binti Bapak Pasangan</strong></td>
                <td>: {{ $data['binti_bapak_pasangan'] }}</td>
            </tr>
            <tr>
