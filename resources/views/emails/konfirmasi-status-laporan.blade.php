...
<body style="font-family: Arial, sans-serif; background-color: #f9fafb; padding: 20px;">
    <div style="background-color: #ffffff; padding: 30px; border-radius: 8px; max-width: 600px; margin: auto;">
        ...
        <p>Pengajuan surat Kamu telah dikonfirmasi perubahan status berikut:</p>
        ...
        <p>Terima kasih telah menggunakan layanan laporan layanan publik online Desa Jampang.</p>
