...
<head>
    <meta charset="UTF-8">
    <title>Konfirmasi Surat Kuasa Pengasuhan Anak</title>
</head>
<body style="font-family: Arial, sans-serif; background-color: #f3f4f6; padding: 40px;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.05); padding: 30px;">
        <div style="text-align: center; margin-bottom: 30px;">
            <h2 style="color: #1f2937; font-size: 22px; margin-bottom: 8px;">Konfirmasi Pengajuan Surat Kuasa Pengasuhan Anak</h2>
        ...
        <p style="font-size: 15px; color: #374151; margin-bottom: 24px;">
            Terima kasih telah mengajukan <strong>Surat Kuasa Pengasuhan Anak</strong>. Berikut ini adalah data permohonan Anda yang kami terima:
        </p>
        ...
        <table style="width: 100%; font-size: 15px; color: #374151; border-spacing: 0 10px;">
            ...
            <tr>
                <td><strong>Alamat Anak</strong></td>
        ...
        <table style="width: 100%; font-size: 15px; color: #374151; border-spacing: 0 10px;">
            ...
            <tr>
                <td><strong>NIK Orang Tua</strong></td>
                <td>: {{ $data['nik_ortu'] }}</td>
            </tr>
        </table>

        <p style="font-size: 15px; color: #374151; margin-top: 24px;">Data Pengasuh:</p>

        <table style="width: 100%; font-size: 15px; color: #374151; border-spacing: 0 10px;">
            <tr>
                <td><strong>Nama Pengasuh</strong></td>
                <td>: {{ $data['nama_pengasuh'] }}</td>
            </tr>
            <tr>
                <td><strong>NIK Pengasuh</strong></td>
                <td>: {{ $data['nik_pengasuh'] }}</td>
            </tr>
        </table>
