    ...
    <section class="relative bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('image/berita.jpg') }}');">
        ...
        <div class="relative container mx-auto px-6 md:px-20 py-16">
            <div class="text-center md:text-start text-white">
                <h2 class="text-3xl md:text-5xl font-bold">Form SuratKeterangan Kematian</h2>
            </div>
        </div>
    </section>
            ...
            @if ($showSuccessModal)
                <div x-data="{ open: true }" x-show="open" x-transition.opacity.duration.300ms class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
                    <div x-show="open" x-transition.scale.duration.300ms class="bg-white p-8 rounded-2xl shadow-2xl max-w-md w-full text-center">
                        ...
                        <h2 class="text-2xl font-semibold text-gray-800 mb-2">Pembuatan Surat Keterangan Kematian Berhasil Dikirim</h2>
        ...
        <div class="container mx-auto px-1 md:px-20">
                ...
                <form wire:submit.prevent="save" class="space-y-4" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model="kewarganegaraan_meninggal" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                <option value="">-- Pilih Salah Satu --</option>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model="agama_meninggal" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                <option value="">-- Pilih Salah Satu --</option>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="tgl_meninggal" wire:model="tgl_meninggal" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                    </div> 
                    <div>
                        <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Alamat Rumah Yang Meninggal</label>
                        <input type="text" name="alamat_meninggal" wire:model="alamat_meninggal" rows="2" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Alamt Rumah Yang Meninggal">
                    </div>     
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Kewarganegaraan</label>
                            <select wire:model="kewarganegaraan_bersangkutan" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                <option value="">-- Pilih Salah Satu --</option>
                                <option value="WNI">Warga Negara Indonesia</option>
                                <option value="WNA">Warga Negara Asing</option>
                            </select>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Agama</label>
                            <select wire:model="agama_bersangkutan" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                <option value="">-- Pilih Salah Satu --</option>
                                <option value="islam">Islam</option>
                                <option value="kristen">Kristen</option>
                                <option value="katolik">Katolik</option>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                         <div>
                            ...
                            <select wire:model="shdk_bersangkutan" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                <option value="">-- Yang Bersangkutan Adalah --</option>
                        ...
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Alamat Rumah Yang Bersangkutan</label>
                            <input type="text" name="alamat_bersangkutan" wire:model="alamat_bersangkutan" rows="2" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Alamt Rumah bersangkutan">
                        </div>
                    </div>      
                    <div>
            ...
            <div class="mt-10 bg-white shadow-xl rounded-xl overflow-hidden border border-gray-200">
                <h2 class="text-xl font-bold text-white px-6 py-4 bg-gradient-to-r from-[#0F5C34] to-[#009A4B]">
                    Riwayat Pengajuan Surat Kematian
                </h2>
                        ...
                        <table class="w-full text-sm text-left text-gray-700">
                            <thead class="bg-green-50 text-gray-900 font-medium">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 sm:px-6 sm:py-4">Nama Meninggal</th>
                                ...
                                @foreach ($suratlist as $surat)
                                    <tr class="hover:bg-gray-50 transition duration-200 ease-in-out">
                                        ...
                                        <td class="px-4 py-3 sm:px-6 sm:py-4 whitespace-nowrap text-gray-600">
                                            {{ $surat->nama_meninggal ?? 'Tidak ditemukan' }}
                                        </td>
