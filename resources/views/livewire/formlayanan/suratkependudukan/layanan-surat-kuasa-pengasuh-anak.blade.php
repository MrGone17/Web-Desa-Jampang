    ...
    <section class="relative bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('image/berita.jpg') }}');">
        ...
        <div class="relative container mx-auto px-6 md:px-20 py-16">
            <div class="text-center md:text-start text-white">
                <h2 class="text-3xl md:text-5xl font-bold">Form Surat Kuasa Pengasuhan Anak</h2>
            </div>
        </div>
    </section>
            ...
            @if ($showSuccessModal)
                <div x-data="{ open: true }" x-show="open" x-transition.opacity.duration.300ms class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
                    <div x-show="open" x-transition.scale.duration.300ms class="bg-white p-8 rounded-2xl shadow-2xl max-w-md w-full text-center">
                        ...
                        <h2 class="text-2xl font-semibold text-gray-800 mb-2">Pembuatan Surat Kuasa Pengasuhan Anak Berhasil Dikirim</h2>
        ...
        <div class="container mx-auto px-1 md:px-20">
            <div class="bg-gray-50 shadow-xl rounded-2xl p-8 md:p-12">
                ...
                <form wire:submit.prevent="save" class="space-y-4" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Masukan Nomor KK Anak </label>
                            <input type="text" name="no_kk_anak" wire:model="no_kk_anak" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Masukan Nomor Kartu Keluarga Anak">
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Waktu Lahir</label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select wire:model="agama_anak" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                <option value="">-- Pilih Salah Satu --</option>
                        ...
                        <div>
                            <div>
                                <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Alamat Rumah Anak</label>
                                <input type="text" name="alamat_anak" wire:model="alamat_anak" rows="2" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Alamt Rumah Anak">
                            </div>
                        </div>
                    </div>
                    <h3 class="text-xl md:text-2xl font-semibold text-gray-800 mb-6">Lengkapi Data Pengasuh</h3>   
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Masukan Nama Kepala Keluarga </label>
                            <input type="text" name="nama_ortu" wire:model="nama_ortu" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Masukan Nama Kepala Keluarga Si Anak">
                        </div>
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Nomor Induk Keluarga</label>
                            <input type="text" name="nik_ortu" wire:model="nik_ortu" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Masukan Nomor Induk Ortu">
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Nomor Kartu Keluarga</label>
                            <input type="text" name="no_kk_ortu" wire:model="no_kk_ortu" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Masukan Nomor Kartu Keluarga">
                        </div>
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Agama</label>
                            <select wire:model="agama_ortu" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                <option value="">-- Pilih Salah Satu --</option>
                                <option value="islam">Islam</option>
                                <option value="kristen">Kristen</option>
                                <option value="katolik">Katolik</option>
                    ...
                    <div>
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Alamat Rumah Orang Tua</label>
                            <input type="text" name="alamat_ortu" wire:model="alamat_ortu" rows="2" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Alamt Rumah Orang Tua">
                        </div>
                    </div>  
                    <h3 class="text-xl md:text-2xl font-semibold text-gray-800 mb-6">Lengkapi Data Pengasuh</h3>   
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Masukan Nama Kepala Keluarga </label>
                            <input type="text" name="nama_pengasuh" wire:model="nama_pengasuh" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Masukan Nama Kepala KeluargaPengasuh">
                        </div>
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Nomor Induk Keluarga</label>
                            <input type="text" name="nik_pengasuh" wire:model="nik_pengasuh" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Masukan Nomor Induk pengasuh">
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Nomor Kartu Keluarga Pengasuh</label>
                            <input type="text" name="no_kk_pengasuh" wire:model="no_kk_pengasuh" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Masukan Nomor Kartu Keluarga Pengasuh">
                        </div>
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Agama</label>
                            <select wire:model="agama_pengasuh" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                <option value="">-- Pilih Salah Satu --</option>
                                <option value="islam">Islam</option>
                                <option value="kristen">Kristen</option>
                                <option value="katolik">Katolik</option>
                    ...
                    <div>
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Alamat Rumah Pengasuh</label>
                            <input type="text" name="alamat_pengasuh" wire:model="alamat_pengasuh" rows="2" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Alamt Rumah Pengasuh">
                        </div>
                    </div> 
                    <div>
            ...
            <div class="mt-10 bg-white shadow-xl rounded-xl overflow-hidden border border-gray-200">
                <h2 class="text-xl font-bold text-white px-6 py-4 bg-gradient-to-r from-[#0F5C34] to-[#009A4B]">
                    Riwayat Pengajuan Surat Kuasa Pengasuhan Anak
                </h2>
                        ...
                        <table class="w-full text-sm text-left text-gray-700">
                            <thead class="bg-green-50 text-gray-900 font-medium">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 sm:px-6 sm:py-4">Nama Anak</th>
                                ...
                                @foreach ($suratlist as $surat)
                                    <tr class="hover:bg-gray-50 transition duration-200 ease-in-out">
                                        ...
                                        <td class="px-4 py-3 sm:px-6 sm:py-4 whitespace-nowrap text-gray-600">
                                            {{ $surat->nama_anak ?? 'Tidak ditemukan' }}
                                        </td>
