    ...
    <section class="relative bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('image/berita.jpg') }}');">
        ...
        <div class="relative container mx-auto px-6 md:px-20 py-16">
            <div class="text-center md:text-start text-white">
                <h2 class="text-3xl md:text-5xl font-bold">Form Surat Keterangan Kehilangan</h2>
            </div>
        </div>
    </section>
            ...
            @if ($showSuccessModal)
                <div x-data="{ open: true }" x-show="open" x-transition.opacity.duration.300ms class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
                    <div x-show="open" x-transition.scale.duration.300ms class="bg-white p-8 rounded-2xl shadow-2xl max-w-md w-full text-center">
                        ...
                        <h2 class="text-2xl font-semibold text-gray-800 mb-2">Pembuatan Surat Keterangan Kehilangan Berhasil Dikirim</h2>
        ...
        <div class="container mx-auto px-1 md:px-20">
                ...
                <form wire:submit.prevent="save" class="space-y-4" enctype="multipart/form-data">
                    ...
                    <div class="grid md:grid-cols-2 grid-cols-1 gap-4">
                        <div>
                            ...
                            <input type="text" name="nama_barang" wire:model="nama_barang" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder=" Nama Barang Yang Hilang">
                        </div>
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Rincian Barang</label>
                            <input type="text" name="rincian" wire:model="rincian" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Rincian Barang Yang Hilang">
                        </div>
                    </div>
                    <div class="grid md:grid-cols-2 grid-cols-1 gap-4">
                        <div>
                            <label class="block mb-1 text-xs md:text-sm font-medium text-gray-700">Keterangan Hilang</label>
                            <input type="text" name="keterangan" wire:model="keterangan" rows="2" class="w-full px-4 py-2 border text-xs md:text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" required placeholder="Keterangan Saat Barang Hilang">
                        </div>
                        <div>
            ...
            <div class="mt-10 bg-white shadow-xl rounded-xl overflow-hidden border border-gray-200">
                <h2 class="text-xl font-bold text-white px-6 py-4 bg-gradient-to-r from-[#0F5C34] to-[#009A4B]">
                    Riwayat Pengajuan Surat Kehilangan
                </h2>
