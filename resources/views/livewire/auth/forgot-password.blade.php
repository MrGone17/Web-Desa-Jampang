<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-700 to-blue-900 relative overflow-hidden">
    ...
    <div wire:loading wire:target="requestReset" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80">
    ...
    <div class="backdrop-blur-lg bg-white/10 border border-white/30 rounded-2xl shadow-2xl p-8 w-full max-w-md z-10">
        ...
        <form wire:submit.prevent="requestReset" class="space-y-5">
            ...
            <div>
                <label class="block text-sm font-medium text-white mb-1">Nomor Induk Keluarga</label>
