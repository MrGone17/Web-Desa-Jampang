...
class LayananSuratnoaktalahir extends Component
{
    use WithFileUploads;
    ...
    public $nama_ayah, $nik_ayah, $pekerjaan_ayah, $tempat_lahir_ayah, $tgl_lahir_ayah, $jenis_kelamin_ayah, $kewarganegaraan_ayah;
    ...
    public function save()
    {
        $this->validate([
            ...
            'kewarganegaraan_anak' => 'required|in:WNI,WNA',
        ...
        $pdfPathpengantar = $this->pengantar_pdf->store('bukti_pengantar_noaktalahir', 'public');

        Suratnoaktalahir::create([
            ...
            'kewarganegaraan_anak' => $this->kewarganegaraan_anak,
        ...
        if ($user?->email) {
            Mail::to($user->email)->send(
                new KonfirmasiSuratnoaktalahir([
    ...
    {
        return view('livewire.formlayanan.suratkependudukan.layanan-suratnoaktalahir');
    }
}
