...
use App\Mail\KonfirmasiSuratIzinKeramaian;
...
class LayananSuratIzinKeramaian extends Component
{
    use WithFileUploads;
    public $suratlist;
    ...
    public function save()
    {
        ...
        SuratIzinKeramaian::create([
            ...
            'jenis_keramaian' => $this->jenis_keramaian,
        ...
        if ($user?->email) {
            Mail::to($user->email)->send(
                new KonfirmasiSuratIzinKeramaian([
        ...
        foreach ($admins as $admin) {
            if ($admin->email) {
                ...
                (new Notifikasiadmin([
                    ...
                    'nama_surat' => 'Surat Keterangan Izin Keramaian',
                    ])
                );
            }
        }
    ...
    public function loadsurat(){
        $this->suratlist = SuratIzinKeramaian::where('warga_id', Auth::guard('warga')->id())->latest()->get()?? collect([]);
    }
    ...
    {
        return view('livewire.formlayanan.suratkependudukan.layanan-surat-izin-keramaian');
    }
}
