...
use App\Mail\KonfirmasiSuratPerubahankk;
...
class LayananSuratPerubahankk extends Component
{
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        if ($user?->email) {
            Mail::to($user->email)->send(
                new KonfirmasiSuratPerubahankk([
        ...
        foreach ($admins as $admin) {
            if ($admin->email) {
                ...
                (new Notifikasiadmin([
                    ...
                    'nama_surat' => 'Surat Keterangan Perubahan Kartu Keluarga',
                    ])
                );
            }
        }
    ...
    public function loadsurat(){
        $this->suratlist = SuratPerubahankk::where('warga_id', Auth::guard('warga')->id())->latest()->get()?? collect([]);
    }
    ...
    {
        return view('livewire.formlayanan.suratkependudukan.layanan-surat-perubahankk');
    }
}
