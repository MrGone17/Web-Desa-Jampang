...
use App\Mail\KonfirmasiSuratmatidanlahir;
...
class LayananSuratmatidanlahir extends Component
{
    use WithFileUploads;
    public $suratlist;
    ...
    public function save()
    {
        ...
        if ($user?->email) {
            Mail::to($user->email)->send(
                new KonfirmasiSuratmatidanlahir([
        ...
        foreach ($admins as $admin) {
            if ($admin->email) {
                ...
                (new Notifikasiadmin([
                    ...
                    'nama_surat' => 'Surat Keterangan Lahir & Mati',
                    ])
                );
            }
        }
    ...
    public function loadsurat(){
        $this->suratlist = Suratmatidanlahir::where('warga_id', Auth::guard('warga')->id())->latest()->get()?? collect([]);
    }
    ...
    {
        return view('livewire.formlayanan.suratkependudukan.layanan-suratmatidanlahir');
    }
}
