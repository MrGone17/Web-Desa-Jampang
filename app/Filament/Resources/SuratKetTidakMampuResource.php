...
use App\Filament\Resources\SuratKetTidakMampuResource\Pages;
use App\Filament\Resources\SuratKetTidakMampuResource\RelationManagers;
...
class SuratKetTidakMampuResource extends Resource
{
    protected static ?string $model = SuratKetTidakMampu::class;

    protected static ?string $pluralModelLabel = 'Surat Keterangan Tidak Mampu';
    ...
    {
        return [
            'index' => Pages\ListSuratKetTidakMampus::route('/'),
            'create' => Pages\CreateSuratKetTidakMampu::route('/create'),
            'edit' => Pages\EditSuratKetTidakMampu::route('/{record}/edit'),
        ];
    }
}
