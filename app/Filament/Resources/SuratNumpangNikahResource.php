...
use App\Filament\Resources\SuratNumpangNikahResource\Pages;
use App\Filament\Resources\SuratNumpangNikahResource\RelationManagers;
...
class SuratNumpangNikahResource extends Resource
{
    protected static ?string $model = SuratNumpangNikah::class;

    protected static ?string $pluralModelLabel = 'Surat Keterangan Numpang Menikah';
    public static function getLabel(): string
    {
        return 'Surat Keterangan Numpang Menikah';
    }
    ...
    {
        return [
            'index' => Pages\ListSuratNumpangNikahs::route('/'),
            'create' => Pages\CreateSuratNumpangNikah::route('/create'),
            'edit' => Pages\EditSuratNumpangNikah::route('/{record}/edit'),
        ];
    }
}
