...
use App\Mail\KonfirmasiStatusPenghasilanOrtu;
use App\Models\Warga;
use Filament\Actions;
use Filament\Resources\Pages\EditRecord;
use Illuminate\Support\Facades\Mail;

class EditSuratKetPenghasilanOrtu extends EditRecord
{
    ...
    public function kirimEmailKonfirmasi($status, $catatan)
    {
        ...
        if ($warga && $warga->email) {
            Mail::to($warga->email)->send(new KonfirmasiStatusPenghasilanOrtu([
                'nama' => $warga->name,
            ...
            Mail::to('gilangelha277@gmail.com')->send(new KonfirmasiStatusPenghasilanOrtu([
                'nama' => 'Admin',
                'status' => ucfirst($status),
