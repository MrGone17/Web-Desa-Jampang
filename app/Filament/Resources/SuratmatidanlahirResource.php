...
use App\Filament\Resources\SuratmatidanlahirResource\Pages;
use App\Filament\Resources\SuratmatidanlahirResource\RelationManagers;
use App\Models\Suratmatidanlahir;
use Filament\Forms;
...
class SuratmatidanlahirResource extends Resource
{
    protected static ?string $model = Suratmatidanlahir::class;

    protected static ?string $pluralModelLabel = 'Surat Keterangan Mati & Lahir';
    public static function getLabel(): string
    {
        return 'Surat Keterangan Mati & Lahir';
    }
    ...
    {
        return [
            'index' => Pages\ListSuratmatidanlahirs::route('/'),
            'create' => Pages\CreateSuratmatidanlahir::route('/create'),
            'edit' => Pages\EditSuratmatidanlahir::route('/{record}/edit'),
        ];
    }
}
