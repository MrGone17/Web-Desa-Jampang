...
use App\Filament\Resources\SyaratketentuanResource\Pages;
use App\Filament\Resources\SyaratketentuanResource\RelationManagers;
...
class SyaratketentuanResource extends Resource
{
        ...
        ->schema([
            ...
            ->schema([
                ...
                Forms\Components\Textarea::make('description')
                    ...
                    ->maxLength(2000)
                    ->helperText('Deskripsikan Syarat & Ketentuan')
                    ->rows(10)
    ...
    {
        return [
            'index' => Pages\ListSyaratketentuans::route('/'),
            'create' => Pages\CreateSyaratketentuan::route('/create'),
            'edit' => Pages\EditSyaratketentuan::route('/{record}/edit'),
        ];
    }
}
