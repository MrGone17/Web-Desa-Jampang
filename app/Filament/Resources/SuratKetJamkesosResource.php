...
use App\Filament\Resources\SuratKetJamkesosResource\Pages;
use App\Filament\Resources\SuratKetJamkesosResource\RelationManagers;
...
class SuratKetJamkesosResource extends Resource
{
    protected static ?string $model = SuratKetJamkesos::class;

     protected static ?string $pluralModelLabel = 'Surat Keterangan Jamkesos';
    public static function getLabel(): string
    {
        return 'Surat Keterangan Jamkesos';
    }   
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('pendidikan')
                    ...
                    ->native(false) 
                    ->searchable(),
                Forms\Components\TextInput::make('no_jamkesos')
                    ->required()
                    ->label('Nomor Kartu Jamkesos')
                    ->maxLength(255),
    ...
    {
        return [
            'index' => Pages\ListSuratKetJamkesos::route('/'),
            'create' => Pages\CreateSuratKetJamkesos::route('/create'),
            'edit' => Pages\EditSuratKetJamkesos::route('/{record}/edit'),
        ];
    }
}
