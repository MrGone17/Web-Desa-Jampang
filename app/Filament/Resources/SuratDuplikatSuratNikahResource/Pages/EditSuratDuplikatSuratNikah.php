...
use App\Mail\KonfirmasiStatusDuplikatSuratCerai;
use App\Models\Warga;
use Filament\Actions;
use Filament\Resources\Pages\EditRecord;
use Illuminate\Support\Facades\Mail;

class EditSuratDuplikatSuratNikah extends EditRecord
{
    ...
    public function kirimEmailKonfirmasi($status, $catatan)
    {
        ...
        if ($warga && $warga->email) {
            Mail::to($warga->email)->send(new KonfirmasiStatusDuplikatSuratCerai([
                'nama' => $warga->name,
            ...
            Mail::to('gilangelha277@gmail.com')->send(new KonfirmasiStatusDuplikatSuratCerai([
                'nama' => 'Admin',
                'status' => ucfirst($status),
