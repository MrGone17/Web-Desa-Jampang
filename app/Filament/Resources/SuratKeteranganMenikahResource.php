...
use App\Filament\Resources\SuratKeteranganMenikahResource\Pages;
use App\Filament\Resources\SuratKeteranganMenikahResource\RelationManagers;
...
class SuratKeteranganMenikahResource extends Resource
{
    protected static ?string $model = SuratKeteranganMenikah::class;

    protected static ?string $pluralModelLabel = 'Surat Keterangan Menikah';
    public static function getLabel(): string
    {
        return 'Surat Keterangan Menikah';
    }
            ...
            ->schema([
                ...
                ->schema([
                    ...
                    Forms\Components\DatePicker::make('tgl_lahir_pasangan')
                        ->required()
                        ->displayFormat('d F Y'),
                    Forms\Components\Select::make('jenis_kelamin_pasangan')
                    ->options([
                            'L' => 'Laki-Laki',
                            'P' => 'Perempuan',
                        ])
    ...
    {
        return [
            'index' => Pages\ListSuratKeteranganMenikahs::route('/'),
            'create' => Pages\CreateSuratKeteranganMenikah::route('/create'),
            'edit' => Pages\EditSuratKeteranganMenikah::route('/{record}/edit'),
        ];
    }
}
