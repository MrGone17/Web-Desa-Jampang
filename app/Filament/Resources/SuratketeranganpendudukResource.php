...
use App\Filament\Resources\SuratketeranganpendudukResource\Pages;
use App\Filament\Resources\SuratketeranganpendudukResource\RelationManagers;
...
class SuratketeranganpendudukResource extends Resource
{
    protected static ?string $model = Suratketeranganpenduduk::class;

    protected static ?string $pluralModelLabel = 'Surat Keterangan Penduduk';
    public static function getLabel(): string
    {
        return 'Surat Keterangan Penduduk';
    }
    ...
    {
        return [
            'index' => Pages\ListSuratketeranganpenduduks::route('/'),
            'create' => Pages\CreateSuratketeranganpenduduk::route('/create'),
            'edit' => Pages\EditSuratketeranganpenduduk::route('/{record}/edit'),
        ];
    }
}
