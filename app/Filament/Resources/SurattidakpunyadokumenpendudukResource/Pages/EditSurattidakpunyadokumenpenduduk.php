...
use App\Mail\KonfirmasiStatusSurattidakpunyadokumen;
use App\Models\Warga;
use Filament\Actions;
use Filament\Resources\Pages\EditRecord;
use Illuminate\Support\Facades\Mail;

class EditSurattidakpunyadokumenpenduduk extends EditRecord
{
    ...
    public function kirimEmailKonfirmasi($status, $catatan)
    {
        ...
        if ($warga && $warga->email) {
            Mail::to($warga->email)->send(new KonfirmasiStatusSurattidakpunyadokumen([
                'nama' => $warga->name,
            ...
            Mail::to('gilangelha277@gmail.com')->send(new KonfirmasiStatusSurattidakpunyadokumen([
                'nama' => 'Admin',
                'status' => ucfirst($status),
