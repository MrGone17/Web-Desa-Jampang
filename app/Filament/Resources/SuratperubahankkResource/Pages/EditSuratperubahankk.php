...
use App\Mail\KonfirmasiStatusperubahankk;
use App\Models\Warga;
use Filament\Actions;
use Filament\Resources\Pages\EditRecord;
use Illuminate\Support\Facades\Mail;

class EditSuratperubahankk extends EditRecord
{
    ...
    public function kirimEmailKonfirmasi($status, $catatan)
    {
        ...
        if ($warga && $warga->email) {
            Mail::to($warga->email)->send(new KonfirmasiStatusperubahankk([
                'nama' => $warga->name,
            ...
            Mail::to('gilangelha277@gmail.com')->send(new KonfirmasiStatusperubahankk([
                'nama' => 'Admin',
                'status' => ucfirst($status),
