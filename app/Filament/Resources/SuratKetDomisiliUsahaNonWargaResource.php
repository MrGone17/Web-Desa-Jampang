...
use App\Filament\Resources\SuratKetDomisiliUsahaNonWargaResource\Pages;
use App\Filament\Resources\SuratKetDomisiliUsahaNonWargaResource\RelationManagers;
...
class SuratKetDomisiliUsahaNonWargaResource extends Resource
{
    protected static ?string $model = SuratKetDomisiliUsahaNonWarga::class;

    protected static ?string $pluralModelLabel = 'Surat Domisili Usaha Non Warga';
    public static function getLabel(): string
    {
        return 'Surat Domisili Usaha Non Warga';
    }   
    ...
    {
        return [
            'index' => Pages\ListSuratKetDomisiliUsahaNonWargas::route('/'),
            'create' => Pages\CreateSuratKetDomisiliUsahaNonWarga::route('/create'),
            'edit' => Pages\EditSuratKetDomisiliUsahaNonWarga::route('/{record}/edit'),
        ];
    }
}
