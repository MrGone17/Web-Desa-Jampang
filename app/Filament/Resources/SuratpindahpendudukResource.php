...
use App\Filament\Resources\SuratpindahpendudukResource\Pages;
use App\Filament\Resources\SuratpindahpendudukResource\RelationManagers;
...
class SuratpindahpendudukResource extends Resource
{
    protected static ?string $model = Suratpindahpenduduk::class;

    protected static ?string $pluralModelLabel = 'Surat Pindah Penduduk';
    public static function getLabel(): string
    {
        return 'Surat Pindah Penduduk';
    }
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('warga.nik')
                    ->label('NIK'),
                Tables\Columns\TextColumn::make('kepala_kk')
                    ->searchable()
    ...
    {
        return [
            'index' => Pages\ListSuratpindahpenduduks::route('/'),
            'create' => Pages\CreateSuratpindahpenduduk::route('/create'),
            'edit' => Pages\EditSuratpindahpenduduk::route('/{record}/edit'),
        ];
    }
}
