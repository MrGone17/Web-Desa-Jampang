...
use App\Filament\Resources\SuratKeteranganCatatanKriminalResource\Pages;
use App\Filament\Resources\SuratKeteranganCatatanKriminalResource\RelationManagers;
...
class SuratKeteranganCatatanKriminalResource extends Resource
{
    protected static ?string $model = SuratKeteranganCatatanKriminal::class;
    protected static ?string $pluralModelLabel = 'Surat Keterangan Catatan Kriminal';
    public static function getLabel(): string
    {
        return 'Surat Keterangan Catatan Kriminal';
    }   
    ...
    {
        return [
            'index' => Pages\ListSuratKeteranganCatatanKriminals::route('/'),
            'create' => Pages\CreateSuratKeteranganCatatanKriminal::route('/create'),
            'edit' => Pages\EditSuratKeteranganCatatanKriminal::route('/{record}/edit'),
        ];
    }
}
