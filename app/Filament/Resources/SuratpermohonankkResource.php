...
use App\Filament\Resources\SuratpermohonankkResource\Pages;
use App\Filament\Resources\SuratpermohonankkResource\RelationManagers;
...
class SuratpermohonankkResource extends Resource
{
    protected static ?string $model = Suratpermohonankk::class;

    protected static ?string $pluralModelLabel = 'Surat Permohonan Kartu Keluarga';
    public static function getLabel(): string
    {
        return 'Surat Permohonan Kartu Keluarga';
    }
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('catatan')
                    ->maxLength(255)
                    ->placeholder('catatan pemberitahuan setelah konfirmasi status')
                    ->default(null),
            ]);
    }
    ...
    {
        return [
            'index' => Pages\ListSuratpermohonankks::route('/'),
            'create' => Pages\CreateSuratpermohonankk::route('/create'),
            'edit' => Pages\EditSuratpermohonankk::route('/{record}/edit'),
        ];
    }
}
