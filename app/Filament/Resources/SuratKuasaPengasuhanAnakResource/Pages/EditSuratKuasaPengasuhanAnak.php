...
use App\Mail\KonfirmasiStatusKuasaPengasuhanAnak;
use App\Models\Warga;
use Filament\Actions;
use Filament\Resources\Pages\EditRecord;
use Illuminate\Support\Facades\Mail;

class EditSuratKuasaPengasuhanAnak extends EditRecord
{
    ...
    public function kirimEmailKonfirmasi($status, $catatan)
    {
        ...
        if ($warga && $warga->email) {
            Mail::to($warga->email)->send(new KonfirmasiStatusKuasaPengasuhanAnak([
                'nama' => $warga->name,
            ...
            Mail::to('gilangelha277@gmail.com')->send(new KonfirmasiStatusKuasaPengasuhanAnak([
                'nama' => 'Admin',
                'status' => ucfirst($status),
