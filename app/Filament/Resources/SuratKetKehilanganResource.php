...
use App\Filament\Resources\SuratKetKehilanganResource\Pages;
use App\Filament\Resources\SuratKetKehilanganResource\RelationManagers;
...
class SuratKetKehilanganResource extends Resource
{
    protected static ?string $model = SuratKetKehilangan::class;

    protected static ?string $pluralModelLabel = 'Surat Kehilangan';
    public static function getLabel(): string
    {
        return 'Surat Kehilangan';
    }   
    ...
    {
        return [
            'index' => Pages\ListSuratKetKehilangans::route('/'),
            'create' => Pages\CreateSuratKetKehilangan::route('/create'),
            'edit' => Pages\EditSuratKetKehilangan::route('/{record}/edit'),
        ];
    }
}
