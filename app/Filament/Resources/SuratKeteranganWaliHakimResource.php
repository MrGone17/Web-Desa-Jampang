...
use App\Filament\Resources\SuratKeteranganWaliHakimResource\Pages;
use App\Filament\Resources\SuratKeteranganWaliHakimResource\RelationManagers;
...
class SuratKeteranganWaliHakimResource extends Resource
{
    protected static ?string $model = SuratKeteranganWaliHakim::class;

    protected static ?string $pluralModelLabel = 'Surat Keterangan Wali Hakim';
    public static function getLabel(): string
    {
        return 'Surat Keterangan Wali Hakim';
    }
    ...
    {
        return [
            'index' => Pages\ListSuratKeteranganWaliHakims::route('/'),
            'create' => Pages\CreateSuratKeteranganWaliHakim::route('/create'),
            'edit' => Pages\EditSuratKeteranganWaliHakim::route('/{record}/edit'),
        ];
    }
}
