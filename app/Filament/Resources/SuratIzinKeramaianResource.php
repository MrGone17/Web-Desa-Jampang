...
use App\Filament\Resources\SuratIzinKeramaianResource\Pages;
use App\Filament\Resources\SuratIzinKeramaianResource\RelationManagers;
...
class SuratIzinKeramaianResource extends Resource
{
        ...
        return $form
            ->schema([
                ...
                Forms\Components\DatePicker::make('berlaku_sampai')
                    ...
                    ->closeOnDateSelection() 
                    ->displayFormat('d F Y'),
                Forms\Components\Select::make('jenis_keramaian')
                    ...
                    ->options([
                        ...
                        'Demo / Aksi Massa' => 'Demo / Aksi Massa',
                        'Pawai / Karnaval' => 'Pawai / Karnaval',
    ...
    {
        return [
            'index' => Pages\ListSuratIzinKeramaians::route('/'),
            'create' => Pages\CreateSuratIzinKeramaian::route('/create'),
            'edit' => Pages\EditSuratIzinKeramaian::route('/{record}/edit'),
        ];
    }
}
