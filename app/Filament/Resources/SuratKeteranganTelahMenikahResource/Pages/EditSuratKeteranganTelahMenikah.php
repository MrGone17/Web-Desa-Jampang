...
use App\Mail\KonfirmasiStatusKeteranganTelahMenikah;
use App\Models\Warga;
use Filament\Actions;
use Filament\Resources\Pages\EditRecord;
use Illuminate\Support\Facades\Mail;

class EditSuratKeteranganTelahMenikah extends EditRecord
{
    ...
    public function kirimEmailKonfirmasi($status, $catatan)
    {
        ...
        if ($warga && $warga->email) {
            Mail::to($warga->email)->send(new KonfirmasiStatusKeteranganTelahMenikah([
                'nama' => $warga->name,
            ...
            Mail::to('gilangelha277@gmail.com')->send(new KonfirmasiStatusKeteranganTelahMenikah([
                'nama' => 'Admin',
                'status' => ucfirst($status),
