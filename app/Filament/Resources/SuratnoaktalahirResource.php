...
use App\Filament\Resources\SuratnoaktalahirResource\Pages;
use App\Filament\Resources\SuratnoaktalahirResource\RelationManagers;
...
class SuratnoaktalahirResource extends Resource
{
    protected static ?string $model = Suratnoaktalahir::class;

     protected static ?string $pluralModelLabel = 'Surat Tidak Punya Akta Lahir';
    public static function getLabel(): string
    {
        return 'Surat Tidak Punya Akta Lahir';
    }
    ...
    {
        return [
            'index' => Pages\ListSuratnoaktalahirs::route('/'),
            'create' => Pages\CreateSuratnoaktalahir::route('/create'),
            'edit' => Pages\EditSuratnoaktalahir::route('/{record}/edit'),
        ];
    }
}
