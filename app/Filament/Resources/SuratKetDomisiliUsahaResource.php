...
use App\Filament\Resources\SuratKetDomisiliUsahaResource\Pages;
use App\Filament\Resources\SuratKetDomisiliUsahaResource\RelationManagers;
...
class SuratKetDomisiliUsahaResource extends Resource
{
    protected static ?string $model = SuratKetDomisiliUsaha::class;

    protected static ?string $pluralModelLabel = 'Surat Domisili Usaha';
    ...
    {
        return [
            'index' => Pages\ListSuratKetDomisiliUsahas::route('/'),
            'create' => Pages\CreateSuratKetDomisiliUsaha::route('/create'),
            'edit' => Pages\EditSuratKetDomisiliUsaha::route('/{record}/edit'),
        ];
    }
}
