...
use App\Filament\Resources\SuratKeteranganTelahMenikahResource\Pages;
use App\Filament\Resources\SuratKeteranganTelahMenikahResource\RelationManagers;
...
class SuratKeteranganTelahMenikahResource extends Resource
{
    protected static ?string $model = SuratKeteranganTelahMenikah::class;

    protected static ?string $pluralModelLabel = 'Surat Keterangan Telah Menikah';
    public static function getLabel(): string
    {
        return 'Surat Keterangan Telah Menikah';
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\DatePicker::make('tgl_menikah')
                        ->required()
                        ->displayFormat('d F Y'),
    ...
    {
        return [
            'index' => Pages\ListSuratKeteranganTelahMenikahs::route('/'),
            'create' => Pages\CreateSuratKeteranganTelahMenikah::route('/create'),
            'edit' => Pages\EditSuratKeteranganTelahMenikah::route('/{record}/edit'),
        ];
    }
}
