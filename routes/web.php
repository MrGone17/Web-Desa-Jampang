...
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratDomisiliUsaha;
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratDomisiliUsahaNonWarga;
...
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratJualBeli;
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratKematian;
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratKeteranganCatatanKriminal;
...
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratKetJamkesos;
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratKetJandaDuda;
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratKetKehilangan;
...
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratPenghasilanOrtu;
...
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratTidakMampu;
use App\Livewire\Formlayanan\Suratkependudukan\LayananSurattidakpunyadokumenpenduduk;
use App\Livewire\Formlayanan\Suratkependudukan\LayananSuratUsaha;
...
Route::get('/Formlayanan/Layanan-Surat-Keterangan-Catatan-Kriminal', LayananSuratKeteranganCatatanKriminal::class)->name('FormsuratLayananSKCK');
Route::get('/Formlayanan/Layanan-Surat-Keterangan-Jamkesos', LayananSuratKetJamkesos::class)->name('FormsuratLayananjamkesos');
Route::get('/Formlayanan/Layanan-Surat-Keterangan-Kehilangan', LayananSuratKetKehilangan::class)->name('FormsuratLayanankehilangan');
Route::get('/Formlayanan/Layanan-Surat-Keterangan-Penghasilan-Ortu', LayananSuratPenghasilanOrtu::class)->name('FormsuratLayananpenghasilanortu');
Route::get('/Formlayanan/Layanan-Surat-Keterangan-Tidak-Mampu', LayananSuratTidakMampu::class)->name('FormsuratLayanantidakmampu');
Route::get('/Formlayanan/Layanan-Surat-Keterangan-Domisili-Usaha', LayananSuratDomisiliUsaha::class)->name('FormsuratLayanandomisiliusaha');
Route::get('/Formlayanan/Layanan-Surat-Keterangan-Domisili-Usaha-Non-Warga', LayananSuratDomisiliUsahaNonWarga::class)->name('FormsuratLayanandomisiliusahanonwarga');
Route::get('/Formlayanan/Layanan-Surat-Keterangan-Jual-Beli', LayananSuratJualBeli::class)->name('FormsuratLayananjualbeli');
Route::get('/Formlayanan/Layanan-Surat-Keterangan-Usaha', LayananSuratUsaha::class)->name('FormsuratLayananusaha');
